...
import (
	...
	docs "govtemplateai/docs" // swagger тодорхойлолт, swaggo-оор init үед бүртгэгддэг
	aiusecase "govtemplateai/internal/business/usecases/ai"
	"govtemplateai/internal/business/usecases/auth"
	bpmusecase "govtemplateai/internal/business/usecases/bpm"
	fedusecase "govtemplateai/internal/business/usecases/federation"
	orgusecase "govtemplateai/internal/business/usecases/organization"
	rbacusecase "govtemplateai/internal/business/usecases/rbac"
	"govtemplateai/internal/business/usecases/users"
	voiceusecase "govtemplateai/internal/business/usecases/voice"
	...
	aipostgres "govtemplateai/internal/datasources/repositories/postgres/ai"
	bpmpostgres "govtemplateai/internal/datasources/repositories/postgres/bpm"
	fedpostgres "govtemplateai/internal/datasources/repositories/postgres/federation"
	orgpostgres "govtemplateai/internal/datasources/repositories/postgres/organization"
	rbacpostgres "govtemplateai/internal/datasources/repositories/postgres/rbac"
	userspostgres "govtemplateai/internal/datasources/repositories/postgres/users"
	voicepostgres "govtemplateai/internal/datasources/repositories/postgres/voice"
	V1Handler "govtemplateai/internal/http/handlers/v1"
	"govtemplateai/internal/http/middlewares"
	"govtemplateai/internal/http/routes"
	"govtemplateai/pkg/aiclient"
	"govtemplateai/pkg/bpmconnector"
	"govtemplateai/pkg/fedsign"
