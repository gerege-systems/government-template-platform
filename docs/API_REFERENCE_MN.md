...
> Текстэн гэрээ [backend/docs/API_CONTRACT.md](../backend/docs/API_CONTRACT.md)-д байгаа.
...
| Method | Path | Purpose |
|--------|------|---------|
| POST | `/sso/start` | dgov OIDC нэвтрэлтийг эхлүүлэх (auth URL буцаана; state-ийг Redis-д хадгална). |
