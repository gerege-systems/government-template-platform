...
> eID + Google login болон сессийн амьдралын мөчлөгийг (`refresh`/`logout`/`poll`) ил гаргадаг. eID
> нь үндсэн нэвтрэлт юм. Сонгодог нэвтрэлтийг дахин идэвхжүүлэхийн тулд одоо байгаа handler-уудыг холбоно уу.
